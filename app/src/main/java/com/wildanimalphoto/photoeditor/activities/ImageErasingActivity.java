...
import com.wildanimalphoto.photoeditor.customviews.BrushImageView;
import com.wildanimalphoto.photoeditor.customviews.TouchImageView;
...
public class ImageErasingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_erasing);
        ...
        Bitmap mapBitmap = Bitmap.createBitmap(EditingActivity.forErase, 0, 0, EditingActivity.forErase.getWidth(), EditingActivity.forErase.getHeight());
        originalBitmap = mapBitmap;
...
//        finalErase = highResolutionOutput;
        setResult(RESULT_OK);
        finish();
    }
    ...
    public void savePhoto(Bitmap bmp) {
        ...
        File imageFileFolder = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "ImageEraser");
