...
import com.wildanimalphoto.photoeditor.activities.MyCreationActivity;

import java.io.File;
import java.text.DecimalFormat;
import java.util.ArrayList;

public class AllMyCreationAdapter extends RecyclerView.Adapter<AllMyCreationAdapter.ViewHolder> {
    Context context;
    ...
    public AllMyCreationAdapter(Context context, ArrayList<String> IMAGEALLARY) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.iv_creationimage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setContentView(R.layout.creating_image);
