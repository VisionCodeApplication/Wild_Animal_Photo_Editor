package com.zerotech.wildanimalphotoeditor.MyTouch;
...
public class FrontOnMultitouch implements OnTouchListener {
    ...
    private class ScaleGestureListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(View view, ScaleGestureDetector detector) {
            ...
            info.deltaScale = FrontOnMultitouch.this.isScaleEnabled ? detector.getScaleFactor() : 1.0f;
            if (FrontOnMultitouch.this.isRotateEnabled) {
                angle = Vector2D.getAngle(this.mPrevSpanVector, detector.getCurrentSpanVector());
            } else {
                angle = 0.0f;
            }
            info.deltaAngle = angle;
            if (FrontOnMultitouch.this.isTranslateEnabled) {
            ...
            info.minimumScale = FrontOnMultitouch.this.minimumScale;
            info.maximumScale = FrontOnMultitouch.this.maximumScale;
            FrontOnMultitouch.this.move(view, info);
            return false;
        }
    }
