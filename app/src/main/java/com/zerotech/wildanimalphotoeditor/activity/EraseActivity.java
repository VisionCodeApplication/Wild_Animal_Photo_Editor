...
import com.zerotech.wildanimalphotoeditor.view.BrushImageView;
import com.zerotech.wildanimalphotoeditor.view.TouchImageView;
...
public class EraseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap mapBitmap = Bitmap.createBitmap(EditActivity.forErase, 0, 0, EditActivity.forErase.getWidth(), EditActivity.forErase.getHeight());
